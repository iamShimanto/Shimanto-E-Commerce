...
export default function AuthShell({
  ...
  return (
    <main
      className={cn(
        "relative min-h-screen overflow-hidden bg-[#eef2ff] text-slate-900",
        className,
      )}
    >
      <div className="absolute inset-x-0 top-0 h-[42vh] bg-[#3f51f7]" />
      <div className="absolute inset-x-0 bottom-0 h-[58vh] bg-[#e9edff]" />

      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl items-center justify-center px-4 py-10 sm:px-6 lg:px-8">
        <section
          className={cn(
            "grid w-full max-w-5xl overflow-hidden rounded-4xl bg-white shadow-[0_30px_80px_rgba(43,62,144,0.18)] lg:grid-cols-2",
            panelClassName,
          )}
        >
          <div className="flex flex-col justify-center p-6 sm:p-10 lg:p-12">
            <div className="mx-auto w-full max-w-md">
              ...
              <div className={cn("space-y-5", contentClassName)}>
                ...
                {footer ? (
                  <div className="border-t border-slate-200 pt-5">{footer}</div>
                ) : null}
              </div>
            </div>
          </div>

          <div className="relative hidden bg-slate-50 lg:flex">
              ...
              <div className="mx-auto flex w-full max-w-sm flex-col items-center text-center">
                <div className="relative mb-8 flex h-64 w-full items-center justify-center">
                  ...
                  <div className="relative flex items-center justify-center">
                    <div className="absolute -left-16 top-10 rounded-2xl bg-white p-4 shadow-lg">
                      <FiPieChart className="h-8 w-8 text-[#3f51f7]" />
                    </div>

                    <div className="absolute -right-14 bottom-8 rounded-2xl bg-white p-4 shadow-lg">
                ...
                <div className="mt-8 flex items-center gap-2">
                  ...
                  <span className="h-1.5 w-10 rounded-full bg-[#cfd6ff]" />
                  <span className="h-1.5 w-10 rounded-full bg-[#cfd6ff]" />
                </div>
              </div>
            </div>
